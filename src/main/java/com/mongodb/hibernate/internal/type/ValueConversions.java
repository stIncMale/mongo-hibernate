...
/**
 * Provides conversion methods between the {@link BsonValue} types, which our
 * {@link PreparedStatement}/{@link ResultSet} implementation uses under the hood and rarely exposes, and the domain
 * types one may use when setting parameter values on a {@link PreparedStatement} or retrieving column values from a
 * {@link ResultSet}.
 */
// VAKOTODO replace `AbstractMqlTranslator.toBsonValue` added in https://github.com/mongodb/mongo-hibernate/pull/81
public final class ValueConversions {
    ...
    public static Object toDomainValue(BsonValue value) {
        assertNotNull(value);
