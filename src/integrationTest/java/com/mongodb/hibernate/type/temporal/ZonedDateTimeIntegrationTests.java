...
class ZonedDateTimeIntegrationTests {
    ...
    @Entity
    record ItemWithUnsupportedId(@Id ZonedDateTime id) {}

    @Entity
    record ItemWithUnsupportedBasicPersistentAttribute(@Id int id, ZonedDateTime v) {}

    @Entity
    record ItemWithUnsupportedArrayPersistentAttribute(@Id int id, ZonedDateTime[] v) {}

    @Entity
    record ItemWithUnsupportedCollectionPersistentAttribute(@Id int id, Collection<ZonedDateTime> v) {}
}
