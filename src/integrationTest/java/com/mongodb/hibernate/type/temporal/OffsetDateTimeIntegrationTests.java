...
class OffsetDateTimeIntegrationTests {
    ...
    @Entity
    record ItemWithUnsupportedId(@Id OffsetDateTime id) {}

    @Entity
    record ItemWithUnsupportedBasicPersistentAttribute(@Id int id, OffsetDateTime v) {}

    @Entity
    record ItemWithUnsupportedArrayPersistentAttribute(@Id int id, OffsetDateTime[] v) {}

    @Entity
    record ItemWithUnsupportedCollectionPersistentAttribute(@Id int id, Collection<OffsetDateTime> v) {}
}
