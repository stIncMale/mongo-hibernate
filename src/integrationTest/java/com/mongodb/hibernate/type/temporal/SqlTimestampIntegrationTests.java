...
class SqlTimestampIntegrationTests {
    ...
    @Entity
    record ItemWithUnsupportedId(@Id Timestamp id) {}

    @Entity
    record ItemWithUnsupportedBasicPersistentAttribute(@Id int id, Timestamp v) {}

    @Entity
    record ItemWithUnsupportedArrayPersistentAttribute(@Id int id, Timestamp[] v) {}

    @Entity
    record ItemWithUnsupportedCollectionPersistentAttribute(@Id int id, Collection<Timestamp> v) {}
}
