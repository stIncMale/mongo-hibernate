...
class OffsetTimeIntegrationTests {
    ...
    @Entity
    record ItemWithUnsupportedId(@Id OffsetTime id) {}

    @Entity
    record ItemWithUnsupportedBasicPersistentAttribute(@Id int id, OffsetTime v) {}

    @Entity
    record ItemWithUnsupportedArrayPersistentAttribute(@Id int id, OffsetTime[] v) {}

    @Entity
    record ItemWithUnsupportedCollectionPersistentAttribute(@Id int id, Collection<OffsetTime> v) {}
}
