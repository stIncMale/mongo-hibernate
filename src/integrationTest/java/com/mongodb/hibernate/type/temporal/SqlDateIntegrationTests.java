...
class SqlDateIntegrationTests {
    ...
    @Entity
    record ItemWithUnsupportedId(@Id Date id) {}

    @Entity
    record ItemWithUnsupportedBasicPersistentAttribute(@Id int id, Date v) {}

    @Entity
    record ItemWithUnsupportedArrayPersistentAttribute(@Id int id, Date[] v) {}

    @Entity
    record ItemWithUnsupportedCollectionPersistentAttribute(@Id int id, Collection<Date> v) {}
}
