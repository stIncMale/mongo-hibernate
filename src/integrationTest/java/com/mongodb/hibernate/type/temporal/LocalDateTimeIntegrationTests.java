...
class LocalDateTimeIntegrationTests {
    ...
    @Entity
    record ItemWithUnsupportedId(@Id LocalDateTime id) {}

    @Entity
    record ItemWithUnsupportedBasicPersistentAttribute(@Id int id, LocalDateTime v) {}

    @Entity
    record ItemWithUnsupportedArrayPersistentAttribute(@Id int id, LocalDateTime[] v) {}

    @Entity
    record ItemWithUnsupportedCollectionPersistentAttribute(@Id int id, Collection<LocalDateTime> v) {}
}
