...
class SqlTimeIntegrationTests {
    ...
    @Entity
    record ItemWithUnsupportedId(@Id Time id) {}

    @Entity
    record ItemWithUnsupportedBasicPersistentAttribute(@Id int id, Time v) {}

    @Entity
    record ItemWithUnsupportedArrayPersistentAttribute(@Id int id, Time[] v) {}

    @Entity
    record ItemWithUnsupportedCollectionPersistentAttribute(@Id int id, Collection<Time> v) {}
}
